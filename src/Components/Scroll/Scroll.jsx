...
const ScrollAnimationComponent = () => {
  ...
  return (
    <div className='scroll'>
      ...
      <div className="box">
        <h2>Centros <br /> de Mesa</h2>
      </div>
      <div className="box">
        <h2>Diseños <br />Propios</h2>
      </div>
      <div className="box">
        <h2>Y mucho <br /> mas...</h2>
      </div>
